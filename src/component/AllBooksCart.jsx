...
const AllBooksCart = ({ booksData }) => {
  ...
  return (
    <div className="grid md:grid-cols-12 gap-4 lg:container mx-auto">
      <div className="bg-[#faf6ef] md:h-[800px] p-3 md:col-span-2 rounded-2xl hidden md:block ">
        ...
        <div className="md:hidden overflow-scroll w-full">
            <div className=" text-start flex overflow-x-scroll w-full">
              <button
                onClick={() => filterBooksData("all")}
                className={`font-bold w-full text-left rounded-xl transition-all duration-300 flex items-center gap-2 mb-2 p-2 
           ${
             selectedCategory === "all"
               ? "bg-[#2e2014] text-white"
               : "hover:bg-[#2e2014] hover:text-white"
